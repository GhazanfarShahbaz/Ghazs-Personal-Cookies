...
def process_create_assignment(assignment_data: dict) -> None:
    ...
    This function takes a dictionary representing assignment data from a request and inserts the data into the AssignmentRepository
...
def process_update_assignment(update_form: dict) -> None:
    ...
    This function takes a dictionary representing update data from a request and uses the data to update an existing assignment
    in the AssignmentRepository.

    Args:
        update_form: A dictionary representing the update data from a request. The required fields are "AssignmentId" and
        "UpdateParams".
...
def process_get_assignment_request(filter_form: dict) -> List[dict]:
    ...
    This function takes a dictionary representing filter data from a request and uses the data to retrieve a list of
    assignments from the AssignmentRepository.

    Args:
        filter_form: A dictionary representing the filter data from a request. The optional fields are "UserId", "ClassId",
        "AssignmentId", "StartDate", "EndDate", and "Status".
...
def process_delete_assignment_request(delete_form: dict) -> None:
    ...
    This function takes a dictionary representing delete data from a request and uses the data to delete an existing assignment
